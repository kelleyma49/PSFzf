...
| `_PSFZF_DISABLE_GIT_COMMIT_IN_PREVIEW` | If this environment variable is set, then fzf will refrain from displaying the current git-commit from a folder in the fzf preview window. |
